...
\endlastfoot
    ...
    \begin{lay}macroscopic\end{lay} \\
        \hyperlink{"v:115"}{ 143 }\hypertarget{"e:143"}{  } &
    \begin{eq}{H}{_{N}} := {m}{_{N}} \stackrel{N}{\star} {{c_p}}{_{N}} \, . \, {T}{_{N}}\end{eq} &
    \begin{lay}Enthalpy from constant heat capacity\end{lay} &
    \begin{lay}macroscopic\end{lay} \\
        \hyperlink{"v:113"}{ 144 }\hypertarget{"e:144"}{  } &
    \begin{eq}{T}{_{N}} := \textbf{Root}\left( {H}{_{N}}  - \left({m}{_{N}} \stackrel{N}{\star} {{c_p}}{_{N}} \, . \, {T}{_{N}}\right)\right)\end{eq} &
    \begin{lay}temperature from constant heat capacity\end{lay} &
    \begin{lay}macroscopic\end{lay} \\
\hline
\end{longtable}